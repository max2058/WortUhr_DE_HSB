...
//WordClock mit Minutenanzeige - Standard
bool WordClockType = HIGH;
//Anzahl der LED's (Minute 1 bis 4)
...
//Farbwert ROT
const unsigned int RGBValueRed = 40;
//Farbwert GRÜN
const unsigned int RGBValueGreen = 90;
//Farbwert BLAU
const unsigned int RGBValueBlue = 30;
